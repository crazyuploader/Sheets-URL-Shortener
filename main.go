...
func (s *server) home(w http.ResponseWriter, req *http.Request) {
	...
	<p>It looks like you have navigated to this page without any parameters in the URL. Please enter a shortened URL (e.g. <a href="https://link.devjugal.com/github">https://link.devjugal.com/github</a>).</p>
	</body>
	</html>`)
}
